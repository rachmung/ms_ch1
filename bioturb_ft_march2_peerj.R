...
#test_v2_ddb_m4 is from bioturb_dd_march2.R
...
bioturb_march3
## PEERJ FIG 4 A) & B) ####
#the pee_plot graph is from weight_rate_simulation.R on line 322
panel <- plot_grid(bioturb_march3, pee_plot, nrow = 1)
panel


######### PEERJ Supplementary Fig 1####################
...
get_se_WR_jan5 <- read_csv("get_se_WR_jan5.csv")
